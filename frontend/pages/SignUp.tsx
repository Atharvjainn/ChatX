        ...
        <CardContent className="grid md:grid-cols-2 p-0">
          ...
          <div className="p-8 sm:px-5">
            <form onSubmit={handleSubmit} className="space-y-6">
              <FieldSet>
                  <FieldLegend className="text-white text-2xl">Create Account</FieldLegend>
                  <FieldDescription className="text-base">Sign up to start chatting</FieldDescription>
                  <FieldGroup>
                  <Field>
                    <FieldLabel htmlFor="username" className="">Username</FieldLabel>
                      <div className="relative">
                        <User className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                        <Input id="username" type="text" placeholder="Max Leiter" className="pl-10"
